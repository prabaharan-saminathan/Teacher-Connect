    ...
    <div className="bg-gray-700 rounded-2xl shadow-xl overflow-hidden">
      ...
      <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-8 rounded-xl">
        ...
        <div className="stats shadow w-full ">
          <div className="stat bg-blue-300 m-4 rounded-xl">
            <div className="stat-title text-blue-900 ml-4">Total Teachers</div>
            <div className="stat-value text-blue-900 ml-4">
              {statsData.statusStats.teachers.total}
            </div>
            <div className="stat-desc text-blue-800 ml-4">
              {statsData.statusStats.teachers.active} Active
            </div>
          </div>

          <div className="stat bg-green-800 m-4 rounded-xl">
            <div className="stat-title text-green-300 ml-4 ">
              Total Students
            </div>
            <div className="stat-value text-green-300 ml-4">
              {statsData.statusStats.students.total}
            </div>
            <div className="stat-desc text-green-300 ml-4">
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h3 className="card-title text-gray-300">Monthly Growth</h3>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h3 className="card-title text-gray-300">
