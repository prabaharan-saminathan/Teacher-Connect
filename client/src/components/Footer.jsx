...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-800 to-gray-800 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Streamlining student-teacher interactions through efficient
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 text-gray-300">
              <Mail size={20} />
              <span>guhansaminathan2003@gmail.com</span>
            </div>
            <div className="flex items-center space-x-3 text-gray-300">
              <Phone size={20} />
              <span>+91 7868901457</span>
            </div>
            <div className="flex items-center space-x-3 text-gray-300">
              <MapPin size={20} />
        ...
        <div className="border-t border-gray-700 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-300 text-sm">
              © {new Date().getFullYear()} Teacher Connect. All rights reserved.
            </div>
