...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        {/* Profile Section */}
        <div className="bg-gray-700 rounded-3xl shadow-xl overflow-hidden mb-8">
          <div className="bg-gray-700 p-6 sm:p-8">
              ...
              <div className="relative group">
                <div className="relative">
                  {user?.profilePic ? (
                    ...
                    <div className="h-24 w-24 sm:h-32 sm:w-32 rounded-full bg-gradient-to-br from-gray-200 to-gray-400
 flex items-center justify-center border-4 border-white/30 shadow-lg">
            ...
            <div className="space-y-4 max-h-[calc(100vh-300px)] overflow-y-auto pr-2 custom-scrollbar">
              {appointments && appointments.length > 0 ? (
                appointments.map((appointment) => (
                  <div
                    key={appointment._id}
                    className={`bg-gray-700 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer ${
 ...
 flex items-center justify-center shadow-md">
                ...
                <div className="text-center py-12 bg-gray-600 rounded-xl shadow-sm">
          ...
          <div className="h-[calc(100vh-300px)]">
            {selectedAppointment ? (
              ...
              <div className="bg-gray-600 rounded-xl shadow-sm p-8 text-center h-full flex items-center justify-center">
                <div>
