...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-800">
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 h-full w-64 bg-gray-700 shadow-lg pt-20 z-40 transition-transform duration-300 transform ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        } sm:translate-x-0`}
      >
        <div className="p-6 border-b bg-gradient-to-r from-gray-700 to-indigo-600">
          <h1 className="text-2xl font-bold text-gray-950">Admin Panel</h1>
          <p className="text-sm text-gray-950 mt-1">Manage your application</p>
        </div>
          ...
          <button
            className={`w-full mb-3 px-4 py-3 text-left flex items-center space-x-3 rounded-lg transition-all duration-200 ${
              activeTab === "manageTeachers"
                ? "bg-gray-70 text-blue-600 shadow-sm"
                : "hover:bg-gray-50"
            }`}
            onClick={() => {
        ...
        <div className="max-w-7xl mx-auto">
          {activeTab === "addTeacher" && (
            <div className="bg-gray-700 rounded-2xl shadow-xl overflow-hidden">
              <div className="p-6 sm:p-8 border-b bg-gradient-to-r from-gray-700 to-indigo-600 ">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="form-control w-full">
                      ...
                      <input
                        ...
                        className="input input-bordered h-12 w-full bg-gray-400 focus:bg-white transition-colors text-base placeholder:text-gray-950"
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="form-control w-full">
                      ...
                      <select
                        ...
                        className="select select-bordered h-12 w-full bg-gray-400 focus:bg-white transition-colors text-base placeholder:text-gray-950"
                        required
                      >
                  ...
                  <div className="form-control w-full">
                    <label className="label mb-2">
                      ...
                      <span className="label-text-alt text-zinc-400">
                    ...
                    <input
                      ...
                      className="input input-bordered h-12 w-full bg-gray-400 focus:bg-gray-300 transition-colors text-base placeholder:text-gray-950 "
                  ...
                  <div className="pt-6">
                    <button
                      type="submit"
                      className="btn w-full sm:w-auto normal-case text-amber-200  hover:bg-green-800 text-white border-none rounded-xl px-6 py-2.5 shadow-lg hover:shadow-xl transition-all duration-200"
                    >
          ...
          {activeTab === "manageTeachers" && (
            <div className="bg-gray-700 rounded-2xl shadow-xl overflow-hidden">
              <div className="p-8 border-b bg-gradient-to-r from-gray-700 to-indigo-600">
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                  <div className="stat bg-gray-900 rounded-xl">
                    <div className="m-4">
                  ...
                  <div className="stat bg-green-900 rounded-xl ">
                    <div className="m-4">
                      <div className="stat-title text-green-400">
                        Active Teachers
                      </div>
                  ...
                  <div className="stat bg-yellow-900 rounded-xl">
                    <div className="m-4">
                      <div className="stat-title text-yellow-400">
                        Pending Approval
                      </div>
                ...
                <div className="overflow-x-auto bg-gray-800 rounded-lg shadow-md">
                  <table className="table w-full">
                    <thead>
                      <tr className="bg-gradient-to-r from-gray-600 to-indigo-600 text-white">
              ...
              <div className="bg-gray-700 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6">
                  <div className="stats shadow">
                    <div className="stat bg-yellow-900 ">
                      <div className="stat-figure text-yellow-400 ml-4">
                        <svg
                      ...
                      <div className="stat-title text-yellow-400 ml-4">
                        Pending Teachers
                      </div>
                      <div className="stat-value text-yellow-400 ml-4">
                        {pendingTeachers.length}
                      </div>
                      <div className="stat-desc text-yellow-500 ml-4">
                        Awaiting Approval
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="overflow-x-auto bg-gray-500 rounded-lg shadow-md">
                    <table className="table w-full">
                      <thead>
                        <tr className="bg-gradient-to-r from-gray-700 to-indigo-600 text-white">
                          <th className="text-center py-4 px-6 font-semibold text-sm uppercase">
                            Teacher Info
                          </th>
                          <th className="text-center py-4 px-6 font-semibold text-sm uppercase">
