    ...
    const fetchAppointments = async () => {
      try {
        ...
        if (data && data.appointments) {
          ...
          const rejected = data.appointments.filter(
  ...
  const handleAppointmentAction = async (appointmentId, action) => {
    try {
      const { data } = await customFetch.patch(
        `/teacher/appointments/${appointmentId}`,
        {
          status: action,
        }
      );
      ...
      if (data.success) {
        ...
        const newPendingRequests = appointments.filter(
          (app) => app._id !== appointmentId && app.status === "pending"
        );
        ...
        setTotalStats((prev) => ({
          ...
          [action === "approved" ? "totalApproved" : "totalRejected"]:
            prev[action === "approved" ? "totalApproved" : "totalRejected"] + 1,
        }));
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-700 text-white text-2xl ">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-4 mt-20">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-300 mb-8">
            Schedule Management
          </h1>
          ...
          <div className="mb-8 bg-yellow-50 rounded-lg p-4">
            ...
            <div className="space-y-4">
              {pendingRequests.map((appointment) => (
                <div
                  key={appointment._id}
                  className="bg-gray-400 rounded-lg p-4 shadow-sm border border-yellow-200"
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          handleAppointmentAction(appointment._id, "approved")
                        }
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 order-2 lg:order-1">
            {selectedView === "schedule" ? (
              <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6">
                <h2 className="text-xl text-black sm:text-2xl font-semibold mb-6">
                    ...
                    >
                      <div className="flex flex-col sm:flex-row gap-4">
                        <select
                          ...
                          className="w-full text-black sm:w-1/3 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
                          required
                        >
                        ...
                        <div className="flex text-black flex-1 gap-2 items-center">
                          <input
                            type="time"
              ...
              <div className="bg-teal-500 rounded-2xl shadow-xl p-4 sm:p-6">
                <h2 className="text-xl text-black sm:text-2xl font-semibold mb-6">
          ...
          <div className="w-full lg:w-80 order-1 lg:order-2">
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 sticky top-24">
              <h3 className="text-lg text-black sm:text-xl font-semibold mb-4">
                Quick Stats
              </h3>
              <div className="space-y-4">
