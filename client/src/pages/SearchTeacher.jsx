        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
              {user?.role === "admin"
                ? "Search for teachers by name or filter by department"
                : "  Search for teachers by name or filter by department to book yourappointment"}
            </p>
          </div>

          {/* Search and Filter Section */}
          <div className="bg-gray-700 rounded-lg shadow-md p-4 sm:p-6 mb-6">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg
                    focus:ring-2 focus:ring-gray-200 focus:border-blue-500 
                    transition-all duration-200
                    text-sm sm:text-base bg-gray-600"
                />
          ...
          <div className="space-y-6">
            {isLoading ? (
              ...
              <div className="text-center py-12 bg-gray-400 rounded-lg shadow-md">
                <p className="text-gray-800">No teachers found</p>
              </div>
            ) : (
              Object.entries(teachers).map(
                ([department, departmentTeachers]) => (
                  <div
                    key={department}
                    className="bg-gray-600 rounded-lg shadow-md overflow-hidden"
                  >
                    <h3 className="text-gray-950 px-4 sm:px-6 py-3 text-lg font-semibold text-zinc-800 border-b">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4 sm:p-6">
                      {departmentTeachers.map((teacher) => (
                        <div
                          ...
                          className="flex flex-col border rounded-lg p-4 hover:shadow-lg transition-shadow duration-200 cursor-pointer bg-gray-500"
                        >
                          {/* Teacher Header */}
                          <div className="flex items-center space-x-4">
                            <div className="relative flex-shrink-0">
                              {teacher.profilePic ? (
                                ...
                                <div className="h-16 w-16 rounded-full bg-gray-100 flex items-center justify-center">
                                  <span className="text-2xl font-semibold text-grat-950">
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className="text-lg font-medium text-gray-950 truncate">
                                {teacher.name}
                              </h4>
                          ...
                          <div className="mt-4 flex-1">
                            <h5 className="text-sm font-medium text-white-700 mb-2">
                              Available Times:
                            </h5>
                            <div className="space-y-2">
                              {teacher.availability.map((slot, index) => (
                                <div
                                  key={index}
                                  className="flex items-center text-sm text-gray-950 bg-gray-50 rounded-md p-3"
                                >
